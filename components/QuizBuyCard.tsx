...
const QuizBuyCard: React.FC<QuizBuyCardProps> = ({ title, category, imageUrl, description,timelimit,totalQuestions,date,passGrade,attempts}) => {
  return (
  ...
  <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
    <div className="md:flex">
      ...
      <div className="md:w-1/3 p-6">
        ...
        <button className="w-full bg-blue-700 text-white py-2 px-4 rounded-full hover:bg-blue-800">
          Start
        </button>
      </div>
    </div>
