...
import { ICourse, IQuiz } from "@/types/interface";
import useGetQuiz from "@/context/getquiz";
import { useParams } from "next/navigation"; // Import useParams for accessing dynamic route parameters
...
const SetUpPage: React.FC = () => {
  ...
  // Use useParams to access route params dynamically
  const params = useParams();
  const quizID = params?.quizID; // Safely access quizID
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-4">
        ...
        <QuizBuyCard
          title={quiz.name}
          category={
            typeof quiz.course_id === "object" && quiz.course_id !== null
              ? (quiz.course_id as ICourse).category
              : "Unknown"
          }
