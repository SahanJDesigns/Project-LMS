...
// import React, { useState, useEffect, useRef } from "react";
// import { fetchCourseDetails, fetchInstructorDetails, fetchLessons, fetchReviews } from "../api/api";
...
//       const courseId = "course1"; // Replace with dynamic course ID
//       const courseData = await fetchCourseDetails(courseId);
//       setCourseDetails(courseData);

//       const instructorData = await fetchInstructorDetails(courseData.instructors[0]);
...
//           </p>
//           <div className="course-meta mb-4">
//             <span className="text-gray-700 text-sm">Created by {instructor.name}</span>
//           </div>
//           <div className="course-meta mb-4">
//             <span className="text-gray-700 text-sm">🌐 {courseDetails.languages.join(", ")}</span>  
//           </div>
...
//       <aside className="col-span-1">
//         <div className="sticky top-8 bg-white p-6 rounded-lg shadow-md">
//           <img src={courseDetails.thumbnail} alt="Course Image" className="w-full rounded-lg mb-4" />
